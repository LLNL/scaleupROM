...
root_dir = '/Users/AXLRSN/Desktop/PrincetonCourses/LLNL24/scaleupROM/build/examples/linelast'
...
# Set the camera position for an axonometric view (example: isometric-like)
renderView1.CameraPosition = [1, 1, 1]  # Adjust as needed
renderView1.CameraFocalPoint = [0, 0, 0]  # Look at the center of the data
renderView1.CameraViewUp = [0, 0, 1]  # Keep the Z-axis pointing upwards
