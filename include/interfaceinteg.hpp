...
protected:
   ...
   VectorConstantCoefficient *lambda, *mu;
...
public:
   InterfaceDGElasticityIntegrator(VectorConstantCoefficient *lambda_, VectorConstantCoefficient *mu_, double alpha_, double kappa_) : lambda(lambda_), mu(mu_), alpha(alpha_), kappa(kappa_) {};
