...
Point(13) = {0.5, 0.5, 0, Lc1};
Point(14) = {0.25, 0.5, 0, Lc1};
Point(15) = {0.5, 0.75, 0, Lc1};
Point(16) = {0.75, 0.5, 0, Lc1};
Point(17) = {0.5, 0.25, 0, Lc1};
...
Physical Curve(3) = {5};
Physical Curve(4) = {7};
Physical Curve(5) = {2, 4, 6, 8, 9, 10, 11, 12};
